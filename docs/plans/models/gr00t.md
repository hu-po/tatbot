...
export DATASET_DIR="$HOME/tatbot/output/train/tatbot-calib-test/dataset" && \
huggingface-cli download \
  --repo-type dataset tatbot/tatbot-calib-test \
  --local-dir $DATASET_DIR
# copy modality config file
cp $HOME/tatbot/config/gr00t_modality.json $DATASET_DIR/meta/modality.json
# load dataset
...
docker run -it --gpus all --shm-size=8g --rm \
  ...
  -v $HOME/tatbot/output/train/tatbot-calib-test/gr00t:/output \
  -v $HOME/Isaac-GR00T:/workspace \
  gr00t-train \
...
scp oop@192.0.2.53:$HOME/tatbot/output/train/tatbot-calib-test/gr00t /tmp/gr00t
