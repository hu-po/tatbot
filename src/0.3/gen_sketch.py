...
log = get_logger('plan_from_image')

@dataclass
class PlanFromImageConfig:
    debug: bool = False
...
def make_plan_from_image(config: PlanFromImageConfig):
...
if __name__ == "__main__":
    args = setup_log_with_config(PlanFromImageConfig)
